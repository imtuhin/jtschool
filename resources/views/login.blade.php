...
<html lang="en">
    ...
    <head>
        ...
        <title>JT School Management Software</title>
		...
		<link rel="stylesheet" href="{{asset('/public')}}/assets/css/form-elements.css">
   ...
   <link rel="icon" href="" />
    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>JT SCHOOL MANAGEMENT SOFTWARE</strong></h1>
        ...
        <script src="{{asset('/public')}}/assets/js/jquery.backstretch.min.js"></script>
